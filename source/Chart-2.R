...
life_expectancy_vs_alcohol_consumption <- ggplot(life_expectancy_with_alcohol_use, aes(y = total_litres_of_pure_alcohol, x = life_expectancy_mean)) + stat_smooth(method = 'loess', formula = 'y ~ x') + geom_line() + coord_cartesian()
